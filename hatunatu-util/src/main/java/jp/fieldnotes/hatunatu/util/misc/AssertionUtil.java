...
import jp.fieldnotes.hatunatu.util.exception.NullArgumentException;
import jp.fieldnotes.hatunatu.util.exception.SIllegalArgumentException;
import jp.fieldnotes.hatunatu.util.exception.SIllegalStateException;
import jp.fieldnotes.hatunatu.util.exception.SIndexOutOfBoundsException;
...
public abstract class AssertionUtil {
    ...
    public static void assertArgumentArrayIndex(final String argName,
        ...
        if (argValue >= arraySize) {
            throw new SIllegalArgumentException(argName, "EUTL0015", ArrayUtil.asArray(
                argName,
                arraySize));
        }
    }
    ...
    public static void assertArgument(final String argName,
        ...
        if (!expression) {
            throw new SIllegalArgumentException(argName, "EUTL0009", ArrayUtil.asArray(
                argName,
                description));
        }
    }
