 ...
 */
package jp.fieldnotes.hatunatu.util.beans.util;
...
import jp.fieldnotes.hatunatu.util.beans.converter.NumberConverter;

import static org.hamcrest.CoreMatchers.*;
import static org.junit.Assert.*;
import static jp.fieldnotes.hatunatu.util.beans.util.CopyOptionsUtil.*;
/**
 * @author higa
 */
public class BeanUtilTest {
    ...
    public void testCopyBeanToMap() throws Exception {
        ...
        src.bbb = "bbb";
        src.ccc = "ccc";
        Map<String, Object> dest = CollectionsUtil.newHashMap();
    ...
    public void testCopyMapToBean() throws Exception {
        Map<String, String> src = CollectionsUtil.newHashMap();
        src.put("aaa", "aaa");
        src.put("bbb", "bbb");
        src.put("ccc", "ccc");
        DestBean dest = new DestBean();
    ...
    public void testCopyMapToBean_includes() throws Exception {
        Map<String, Object> src = CollectionsUtil.newHashMap();
        src.put("aaa", "aaa");
        src.put("bbb", "bbb");
        src.put("ccc", "ccc");
        DestBean dest = new DestBean();
