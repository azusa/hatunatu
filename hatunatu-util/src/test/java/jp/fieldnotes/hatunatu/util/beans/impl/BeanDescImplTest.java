...
public class BeanDescImplTest {
    ...
    public void testPropertyDesc() throws Exception {
        ...
        assertThat(propDesc.getPropertyType(), CoreMatchers.is(TestUtil.sameClass(String.class)));
        ...
        assertThat(propDesc.getPropertyType(), CoreMatchers.is(TestUtil.sameClass(boolean.class)));
        assertThat(propDesc.getReadMethod(), is(notNullValue()));
        assertThat(propDesc.getWriteMethod(), is(nullValue()));
    ...
    public void testAddFields() throws Exception {
        ...
        assertThat(pd.getPropertyType(), CoreMatchers.is(TestUtil.sameClass(String.class)));
    }
    ...
    public void testFieldType() throws Exception {
        ...
        assertThat(
            ...
            CoreMatchers.is(TestUtil.sameClass(String.class)));

        ParameterizedClassDesc pcd = pd.getParameterizedClassDesc();
        assertThat(pcd.getRawClass(), CoreMatchers.is(TestUtil.sameClass(List.class)));
        ...
        assertThat(
            pd.getElementClassOfCollection(),
            CoreMatchers.is(TestUtil.sameClass(Object.class)));
    ...
    public void testGetter() throws Exception {
        ...
        assertThat(
            pd.getElementClassOfCollection(),
            CoreMatchers.is(TestUtil.sameClass(Integer.class)));

        ParameterizedClassDesc pcd = pd.getParameterizedClassDesc();
        assertThat(pcd.getRawClass(), CoreMatchers.is(TestUtil.sameClass(Set.class)));
        assertThat(pcd.getArguments().length, is(1));
        assertThat(
            pcd.getArguments()[0].getRawClass(),
            CoreMatchers.is(TestUtil.sameClass(Integer.class)));
        ...
        assertThat(pd.isParameterized(), is(true));
        assertThat(pd.getElementClassOfCollection(), CoreMatchers.is(TestUtil.sameClass(Enum.class)));
        ...
        assertThat(
            pcd.getArguments()[0].getRawClass(),
            CoreMatchers.is(TestUtil.sameClass(Enum.class)));
    }
    ...
    public void testSetter() throws Exception {
        ...
        assertThat(pd.isParameterized(), is(true));
        assertThat(pd.getKeyClassOfMap(), CoreMatchers.is(TestUtil.sameClass(String.class)));
        assertThat(pd.getValueClassOfMap(), CoreMatchers.is(TestUtil.sameClass(Date.class)));

        ParameterizedClassDesc pcd = pd.getParameterizedClassDesc();
        assertThat(pcd.getRawClass(), CoreMatchers.is(TestUtil.sameClass(Map.class)));
        ...
        assertThat(
            ...
            CoreMatchers.is(TestUtil.sameClass(Date.class)));

        pd = bd.getPropertyDesc("hege");
        assertThat(pd.isParameterized(), is(true));
        assertThat(pd.getKeyClassOfMap(), CoreMatchers.is(TestUtil.sameClass(String.class)));
        assertThat(pd.getValueClassOfMap(), CoreMatchers.is(TestUtil.sameClass(Number.class)));
        ...
        assertThat(
            pcd.getArguments()[1].getRawClass(),
            CoreMatchers.is(TestUtil.sameClass(Number.class)));
    }
