...
public class FieldUtilTest {
    ...
    public void testGetKeyTypeOfMap() throws Exception {
        ...
        assertThat(FieldUtil.getKeyTypeOfMap(f), CoreMatchers.is(TestUtil.sameClass(String.class)));
        assertThat(FieldUtil.getValueTypeOfMap(f), CoreMatchers.is(TestUtil.sameClass(Integer.class)));
    }
