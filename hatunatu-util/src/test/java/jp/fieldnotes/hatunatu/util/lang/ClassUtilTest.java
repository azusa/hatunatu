...
import jp.fieldnotes.hatunatu.util.exception.EmptyArgumentException;
import jp.fieldnotes.hatunatu.util.exception.NoSuchConstructorRuntimeException;
...
public class ClassUtilTest {
    ...
    public void testGetPackageName() {
        assertThat(
            ...
            is("jp.fieldnotes.hatunatu.util.lang"));
    }
    ...
    public void testGetResourcePath() {
        assertThat(
            ...
            is("jp/fieldnotes/hatunatu/util/lang/ClassUtilTest.class"));
    }
    ...
    public void testConvertClass() {
        assertThat(ClassUtil.convertClass("int"), CoreMatchers.is(TestUtil.sameClass(int.class)));
        assertThat(
