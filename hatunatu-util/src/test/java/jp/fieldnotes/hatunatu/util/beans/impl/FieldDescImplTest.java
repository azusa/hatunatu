...
public class FieldDescImplTest {
    ...
    public void testHOGE() throws Exception {
        ...
        assertThat(hoge.getFieldType(), CoreMatchers.is(TestUtil.sameClass(String.class)));
    ...
    public void testAaa() throws Exception {
        ...
        assertThat(aaa.getFieldType(), CoreMatchers.is(TestUtil.sameClass(Class.class)));
        ...
        assertThat(
            ...
            CoreMatchers.is(TestUtil.sameClass(Class.class)));
        MyBean myBean = new MyBean();
        aaa.setFieldValue(myBean, String.class);
        assertThat(aaa.getFieldValue(myBean), CoreMatchers.is(TestUtil.sameClass(String.class)));
    }
    ...
    public void testMap() throws Exception {
        ...
        assertThat(hoge.getKeyClassOfMap(), CoreMatchers.is(TestUtil.sameClass(String.class)));
        assertThat(hoge.getValueClassOfMap(), CoreMatchers.is(TestUtil.sameClass(Integer.class)));
    }
