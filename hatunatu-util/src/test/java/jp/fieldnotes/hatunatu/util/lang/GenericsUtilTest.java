...
public class GenericsUtilTest {
    ...
    public void testGenericMethod() throws Exception {
        ...
        assertThat(returnClass, CoreMatchers.is(TestUtil.sameClass(Object.class)));
    }
    ...
    public void testArray() throws Exception {
        ...
        assertThat(GenericsUtil.getRawClass(t2), CoreMatchers.is(TestUtil.sameClass(Class.class)));
        assertThat(
    ...
    public void testGetTypeVariableMap() throws Exception {
        ...
        assertThat(entry.getValue(), CoreMatchers.is(TestUtil.sameClass(Integer.class)));
        entry = it.next();
        assertThat(entry.getKey().getName(), is("T2"));
        assertThat(entry.getValue(), CoreMatchers.is(TestUtil.sameClass(Long.class)));
        entry = it.next();
        assertThat(entry.getKey().getName(), is("T1"));
        assertThat(entry.getValue(), CoreMatchers.is(TestUtil.sameClass(String.class)));
        entry = it.next();
        assertThat(entry.getKey().getName(), is("T2"));
        assertThat(entry.getValue(), CoreMatchers.is(TestUtil.sameClass(Boolean.class)));
    }
    ...
    public void testGetActualClass() throws Exception {
        ...
        assertThat(GenericsUtil.getActualClass(
            ...
            map), CoreMatchers.is(TestUtil.sameClass(Integer.class)));
        assertThat(
            GenericsUtil.getActualClass(method.getGenericReturnType(), map),
            CoreMatchers.is(TestUtil.sameClass(Long.class)));
        ...
        assertThat(
            GenericsUtil.getActualClass(method.getGenericReturnType(), map),
            CoreMatchers.is(TestUtil.sameClass(List.class)));

        method = Hoge.class.getMethod("set");
        assertThat(
            GenericsUtil.getActualClass(method.getGenericReturnType(), map),
            CoreMatchers.is(TestUtil.sameClass(Set.class)));

        method = Hoge.class.getMethod("map");
        assertThat(
            GenericsUtil.getActualClass(method.getGenericReturnType(), map),
            CoreMatchers.is(TestUtil.sameClass(Map.class)));
    }
    ...
    public void testGetActualElementClassOfList() throws Exception {
        ...
        assertThat(
            GenericsUtil.getActualElementClassOfList(
                method.getGenericReturnType(),
                map),
            CoreMatchers.is(TestUtil.sameClass(Boolean.class)));
    }
    ...
    public void testGetActualKeyClassOfMap() throws Exception {
        ...
        assertThat(GenericsUtil.getActualKeyClassOfMap(
            method.getGenericReturnType(),
            map), CoreMatchers.is(TestUtil.sameClass(String.class)));
    }
    ...
    public void testGetActualValueClassOfMap() throws Exception {
        ...
        assertThat(GenericsUtil.getActualValueClassOfMap(
            method.getGenericReturnType(),
            map), CoreMatchers.is(TestUtil.sameClass(Boolean.class)));
    }
