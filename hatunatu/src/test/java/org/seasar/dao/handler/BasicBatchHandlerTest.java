...
public class BasicBatchHandlerTest extends S2TestCase {
    ...
    public void testExecuteTx() throws Exception {
        ...
        org.seasar.dao.handler.BasicBatchHandler handler = new org.seasar.dao.handler.BasicBatchHandler(getDataSource(), sql,
                2);
    ...
    public void testExceptionByWrongDataTypeTx() throws Exception {
        ...
        org.seasar.dao.handler.BasicBatchHandler handler = new BasicBatchHandler(getDataSource(), sql,
                2);
        List list = new ArrayList();
