...
public class BasicHandlerTest extends S2TestCase {
    ...
    public void testLogSql() throws Exception {
        ...
        Class[] argTypes = new Class[] { String.class, BigDecimal.class,
                Integer.class };
        org.seasar.dao.handler.BasicHandler handler = new org.seasar.dao.handler.BasicHandler(getDataSource(), sql);
        assertTrue(handler.getLoggerClass() == org.seasar.dao.handler.BasicHandler.class);
